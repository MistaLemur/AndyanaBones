...
//   at runtime which call the KeyUp, KeyDown, and KeyRepeat verbs.
//   These verbs call key_up, key_down, and key_repeat procs which
//   you can override to make new actions happen. The client's focus
//   var is a reference to the object that receives the key_up,
//   key_down, and key_repeat events.
